...
write.xlsx(as.data.frame(ego_simpl), "data/human_GO_result.xlsx")

# Export barplot to PDF
pdf("data/Human_GO_BP_barplot.pdf", width = 12, height = 10)
barplot(ego_simpl, showCategory = 30, title = "Top 30 GO BP Terms (Human)")
dev.off()

# Export dotplot to PDF
pdf("data/Human_GO_BP_dotplot.pdf", width = 12, height = 10)
